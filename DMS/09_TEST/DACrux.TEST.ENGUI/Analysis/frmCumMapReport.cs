...
{
    public partial class frmCumMapReport : DACrux.Framework.Base.DACruxUXBasic01, DACrux.TEST.Interface.iTESTControl, DACrux.Framework.Base.IExportExcel
    {
        ...
        private void fnWaferBinChart(DataTable dtData, string[] strBinNoList)
        {
            ...
            try
            {
                chartTrend.Legends.Clear();
                chartTrend.ChartAreas.Clear();
                chartTrend.ChartAreas.Add("Default");
                chartTrend.Series.Clear();
                chartTrend.Series.Add("Default");

                chartTrend.Series["Default"].SmartLabelStyle.Enabled = true;
                chartTrend.Series["Default"].SmartLabelStyle.AllowOutsidePlotArea = LabelOutsidePlotAreaStyle.Yes;
                chartTrend.Series["Default"].SmartLabelStyle.CalloutLineAnchorCapStyle = LineAnchorCapStyle.Arrow;
                chartTrend.Series["Default"].SmartLabelStyle.CalloutLineColor = Color.Black;
                chartTrend.Series["Default"].SmartLabelStyle.CalloutLineWidth = 1;
                chartTrend.Series["Default"].SmartLabelStyle.CalloutStyle = LabelCalloutStyle.None;
                chartTrend.Series["Default"].MarkerSize = 2;
                chartTrend.Series["Default"].MarkerStyle = System.Windows.Forms.DataVisualization.Charting.MarkerStyle.Circle;
                chartTrend.Series["Default"].BorderWidth = 2;
                chartTrend.Series["Default"].ChartType = SeriesChartType.Column;
                chartTrend.Series["Default"].IsValueShownAsLabel = true;
                ...
                for (int ir = 0; ir < strBinNoList.Length; ir++)
                {
                    ...
                    pt = new DataPoint(chartTrend.Series["Default"]);

                    pt.Tag = strBinNo;
                    pt.ToolTip = String.Format("{0} : {1}", strBinName, iValue);
                    pt.BorderWidth = 2;
                    pt.SetValueXY(strBinName, iValue);
                    chartTrend.Series["Default"].Points.Add(pt);
                }
