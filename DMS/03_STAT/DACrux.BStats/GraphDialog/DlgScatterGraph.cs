...
{
    public partial class DlgScatterGraph : Form, iGraphAnalysis
    {

        #region " MEMBER FIELD "

        public string FUNC_CODE = "F0403";
        ...
        public DlgScatterGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo)
            :this(dataSource, lstValidColumnInfo, "Graph Analysis")
        {
        }

        public DlgScatterGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo, string createdInformation)
        {
            InitializeComponent();

            graphInfo = new GraphInformation();
            graphInfo.Type = GraphType.Scatter;
        ...
        public DlgScatterGraph(GraphInformation graphInfo)
        {
            InitializeComponent();
        ...
        private void LoadCommonSetting(GraphInformation graphInfo)
        {
            ...
            nudPointSize.Value = Convert.ToDecimal(graphInfo.PointSize);
        ...
        private void SaveCommonSetting(GraphInformation graphInfo)
        {
            ...
            graphInfo.PointSize = Convert.ToInt16(nudPointSize.Value);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < lvSeries.Items.Count; i++)
            {
                ...
                {
                    strMessage = "Only number type columns can be series member.";
                    break;
                }
            }
