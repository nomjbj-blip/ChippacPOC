...
{
    public partial class DlgPieGraph : Form, iGraphAnalysis
    {

        #region " MEMBER FIELD "

        public string FUNC_CODE = "F0401";
        ...
        public DlgPieGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo)
            :this(dataSource, lstValidColumnInfo, "Graph Analysis")
        {
        }

        public DlgPieGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo, string createdInformation)
        {
            InitializeComponent();

            graphInfo = new GraphInformation();
            graphInfo.Type = GraphType.Pie;
        ...
        public DlgPieGraph(GraphInformation graphInfo)
        {
            InitializeComponent();
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < lvSeries.Items.Count; i++)
            {
                ...
                {
                    strMessage = "Only number type columns can be series membeMouseDoubleClickr.";
                    break;
                }
            }
