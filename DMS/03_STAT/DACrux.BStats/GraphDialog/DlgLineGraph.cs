...
{
    public partial class DlgLineGraph : Form, iGraphAnalysis
    {
        #region " MEMBER FIELD "

        public string FUNC_CODE = "F0404";
        ...
        #region " CREATOR "
         ...
         public DlgLineGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo)
            :this(dataSource, lstValidColumnInfo, "Graph Analysis")
        {
        }

        public DlgLineGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo, string createdInformation)
        {
            InitializeComponent();

            graphInfo = new GraphInformation();
            graphInfo.Type = GraphType.Line;
        ...
        public DlgLineGraph(GraphInformation graphInfo)
        {
            InitializeComponent();
