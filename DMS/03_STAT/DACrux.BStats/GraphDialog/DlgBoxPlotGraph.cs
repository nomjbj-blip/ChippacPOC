...
{
    public partial class DlgBoxPlotGraph : Form, iGraphAnalysis
    {
        #region " MEMBER FIELD "

        public string FUNC_CODE = "F0405";
        ...
        public DlgBoxPlotGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo)
            :this(dataSource, lstValidColumnInfo, "Graph Analysis")
        {
        }

        public DlgBoxPlotGraph(DataTable dataSource, List<DACrux.ProjectManager.UI.DataView.ColumnInfo> lstValidColumnInfo, string createdInformation)
        {
            InitializeComponent();

            graphInfo = new GraphInformation();
            graphInfo.Type = GraphType.BoxPlot;
        ...
        public DlgBoxPlotGraph(GraphInformation graphInfo)
        {
            InitializeComponent();
