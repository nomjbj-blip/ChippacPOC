...
{
    public partial class DlgTwoSampleUnpaired : Form
    {
        #region " MEMBER FIELD "
        string m_Title = "Unpaired t test";
        ...
        public DlgTwoSampleUnpaired(SelectedHypothesisTestingMethods oSelected)
        {
            InitializeComponent();
            InitDialog();
