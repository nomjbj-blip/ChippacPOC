...
{
	public class TQD_SETUP_MAP  : Miracom.Middleware.QueryComponent
	{
		public TQD_SETUP_MAP()
		{
            ...
            try
            {
                ...
                this.InitQueryComponent(connectID, "TQD_SETUP_MAP.xml");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertExecuteMultiple(string sqlName, string[,] paras)
        {
            try
            {
                this.ExecuteMultipleEx(sqlName, null, paras);
            }
            catch (Exception ex)
            {
                throw ex;
