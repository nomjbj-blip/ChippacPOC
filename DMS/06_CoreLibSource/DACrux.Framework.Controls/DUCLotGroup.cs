...
namespace DACrux.Framework.Controls
{
    ...
    /// 
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(DUCLotGroup), "DUCLotGroup.bmp")]
    public partial class DUCLotGroup : System.Windows.Forms.UserControl
	{
		public DUCLotGroup()
		{
        ...
        private void treeView1_DragOver(object sender, System.Windows.Forms.DragEventArgs e)
        {
            try
            {
                ...
                Debug.WriteLine(string.Format("{0},{1}",cp.X,cp.Y));
        ...
        private void mnuAddLot_Click(object sender, System.EventArgs e)
        {
            ...
            {
                throw new Exception("Lot Add를 할 수 없습니다", ex);
            }
        }
        ...
        private void mnuDelLot_Click(object sender, System.EventArgs e)
        {
            ...
            {
                throw new Exception("Delete Lot을 할 수 없습니다.", ex);
            }
        }
        ...
        private void mnuDelGroup_Click(object sender, System.EventArgs e)
        {
            ...
            {
                throw new Exception("Delete Group을 할 수 없습니다.", ex);
            }
        }
        ...
        private void mnuResetAll_Click(object sender, System.EventArgs e)
        {
            ...
            {
                throw new Exception("트리를 Reset할 수 없습니다.", ex);
            }
        } 
