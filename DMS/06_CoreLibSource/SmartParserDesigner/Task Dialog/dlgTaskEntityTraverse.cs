...
{
    public partial class dlgTaskEntityTraverse : Form, ITaskDialog
    {
        #region " Member Field "
        ...
        private EntityTraverseTask task;
        ...
        public dlgTaskEntityTraverse()
        {
            ...
            task = new EntityTraverseTask();

            InitDialog();
        }

        public dlgTaskEntityTraverse(EntityTraverseTask task)
        {
            DACrux.SP.Common.MultiLang funclang = new MultiLang();
