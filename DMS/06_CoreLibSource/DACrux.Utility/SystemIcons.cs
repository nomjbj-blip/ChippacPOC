...
{
    // 시스템의 아이콘 가져오기 2019.08.15 Taihi,Kim.
    public static class SystemIcons
    {
        ...
        public static System.Drawing.Icon GetFolderIcon(bool isOpen = false)
        {
            return IconReader.GetFolderIcon(IconReader.IconSize.Small, isOpen ? IconReader.FolderType.Open : IconReader.FolderType.Closed);
        }
        ...
        internal class IconReader
        {
            ...
            public static System.Drawing.Icon GetFolderIcon(IconSize size, FolderType folderType)
            {
                ...
                // Get the folder icon
                Shell32.SHFILEINFO shfi = new Shell32.SHFILEINFO();
                Shell32.SHGetFileInfo(System.IO.Path.GetTempPath(),
        ...
        /// </summary>
        internal class IconListManager
        {
