...
namespace DACrux.Utility
{
    ...
    public class ExcelUtil : IDisposable
	{
            ...
            int rowIdx2, int colIdx2, string[,] values)
        {
            ...
            Microsoft.Office.Interop.Excel.Range c1 = workSheet.Cells[rowIdx1, colIdx1];
            Microsoft.Office.Interop.Excel.Range c2 = workSheet.Cells[rowIdx2, colIdx2];
            ...
            int rowIdx2, int colIdx2)
        {
            ...
            Microsoft.Office.Interop.Excel.Range c1 = workSheet.Cells[rowIdx1, colIdx1];
            Microsoft.Office.Interop.Excel.Range c2 = workSheet.Cells[rowIdx1, colIdx1];
            ...
            int rowIdx, int colIdx)
        {
            ...
            Microsoft.Office.Interop.Excel.Range c1 = workSheet.Cells[rowIdx, colIdx];
            Microsoft.Office.Interop.Excel.Range c2 = workSheet.Cells[rowIdx, colIdx];
        ...
        public void fnAllCellResize(Excel._Workbook workbook, int sheetIdx, int width, int height)
        {
            try
            {
                ...
                workSheet.Rows.RowHeight = (height * 375 / 500) + 10;
                workSheet.Columns.ColumnWidth = (width * 54.78 / 500) + 10;
            }
            catch (Exception ex)
            {
                throw ex;
