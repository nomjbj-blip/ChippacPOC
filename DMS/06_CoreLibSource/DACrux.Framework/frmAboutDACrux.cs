...
--
--  Program Id      : frmAboutDACrux.cs
--  Creator         : YoungShin Lim (YSIM)
--  Create Date     : 2014.11.14
--  Description     : DACrux Framework::DACrux 의 About DACrux
...
{
    public partial class frmAboutDACrux : Form, DACrux.Framework.Interface.iDACruxModalForm
    {
        public frmAboutDACrux()
        {
            InitializeComponent();
