...
namespace DACrux.Common.Setup
{
    ...
    /// Sensor Mix Setup 화면
    /// </summary>
    public partial class frmEquipModelSetup : DACrux.Framework.Base.DACruxUXBasic02
    {
        ...
        /// </summary>
        private void frmEquipModelSetup_Load(object sender, EventArgs e)
        {
        ...
        /// </summary>
        public string[] GetSelectedItemsToArray(ListBox listBox)
        {
        ...
        private void SetSpreadData()
        {
            try
            {
                ...
                DataTable dt = obj.GetEquipModel02(
        ...
        private void grid_CommandButtonClick(object sender, Framework.PropertyGrid.CommandEventArgs e)
        {
            ...
            string equipModel = grid.GetValue("EQUIP_MODEL") as string;
            bool exists = obj.ExistsEquipModelData(GlobalVariable.Factory, equipModel);
            ...
            if (e.Mode == Framework.PropertyGrid.CommandMode.Insert)
            {
                ...
                if (result == System.Windows.Forms.DialogResult.OK)
                    obj.InsertEquipModelData(grid.GetDictionaryValue(), GlobalVariable.UserID);
                else
                    e.Cancel = true;
            }
            else if (e.Mode == Framework.PropertyGrid.CommandMode.Update)
            {
                ...
                if (result == System.Windows.Forms.DialogResult.OK)
                    obj.UpdateEquipModelData(grid.GetDictionaryValue(), GlobalVariable.UserID);
                else
                    e.Cancel = true;
            }
            else if (e.Mode == Framework.PropertyGrid.CommandMode.Delete)
            {
                ...
                if (result == System.Windows.Forms.DialogResult.OK)
                    obj.DeleteEquipModelData(GlobalVariable.Factory, equipModel);
                else
                    e.Cancel = true;
            }
        }
